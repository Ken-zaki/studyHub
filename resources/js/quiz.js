...
(function () {
    ...
    function setupQuizSets(state, el) {
        ...
        const qel = {
            ...
            screenMenuBackBtn: document.querySelector("#screenQuiz .back-btn[data-target='screenMenu']"),
        ...
        function renderReviewPanel(questions) {
            ...
            qel.reviewList.innerHTML = questions.map(function (q, i) {
                ...
                const explanation = q.explanation
                    ...
                    : "";
                return (
                    '<div class="quiz-review-card" data-question-id="' + esc(String(q.id)) + '" style="position:relative;padding-top:2.2rem;">' +
