    ...
    <div class="fm-wrapper" id="focusModeApp">
        ...
        <main class="fm-main" id="mainContent">
            ...
            <section class="materials-panel hidden" id="materialsPanel">
                ...
                <p class="materials-help" id="materialsHelp">Attach materials to the study mode you are currently using.
                </p>
                ...
                <div class="content-area flashcard-area" id="flashcardContent">
                    <div class="flashcard-builder" id="flashcardBuilder">
                        <div class="flashcard-builder-header">
                            ...
                            <button class="flashcard-create-btn" id="flashcardCreateBtn" type="button">+ Create
                                Flashcard</button>
                        </div>
            ...
            <div class="music-controls">
                <button class="ctrl-btn" id="shuffleBtn" title="Shuffle">
                    <svg viewBox="0 0 24 24">
                        <path
                            d="M16 3h5v5l-1.5-1.5-4.5 4.5-1.5-1.5 4.5-4.5L16 3zm-7 1L3 10l2 2 6-6-2-2zm2 10l-4 4 1.5 1.5L12 16l3.5 3.5L17 18l-4-4zm6.5-1.5L16 10l-2 2 4.5 4.5L17 18h5v-5l-1.5 1.5z" />
                    </svg>
                </button>
                ...
                <button class="ctrl-btn ctrl-play" id="playPauseBtn" title="Play/Pause">
                    <svg viewBox="0 0 24 24" id="playIcon" class="hidden">
                ...
                <button class="ctrl-btn" id="nextBtn" title="Next">
                    <svg viewBox="0 0 24 24">
                        <path d="m6 18 8.5-6L6 6v12zm2.5-6L6 6v12l8.5-6zM16 6v12h2V6z" />
                    </svg>
                </button>
