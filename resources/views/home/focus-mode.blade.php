...
<div class="fm-wrapper" id="focusModeApp">
    ...
    {{-- ══ TOP BAR BACK BUTTON ══ --}}
    <button id="focusTopBackBtn" class="focus-top-back-btn hidden" type="button" aria-label="Back to menu">
        ← Back
    </button>
                    ...
                    <div style="display:flex;flex-direction:column;gap:14px;">
                        <div class="tracker-card" style="min-height:100px;">
                            ...
                            <div style="display:flex;align-items:center;gap:10px;margin-bottom:9px;">
                                <div class="tracker-skeleton" style="width:9px;height:9px;border-radius:50%;flex-shrink:0;"></div>
                                <div class="tracker-skeleton" style="flex:1;height:10px;"></div>
                                <div class="tracker-skeleton" style="width:34px;height:5px;flex-shrink:0;"></div>
                            </div>
                            @endfor
                        </div>
                        <div class="tracker-card">
                            ...
                            <div style="display:flex;gap:7px;">
                                @for ($i = 0; $i < 7; $i++)
                                <div class="tracker-skeleton" style="width:30px;height:30px;border-radius:8px;flex-shrink:0;"></div>
                                @endfor
                            </div>
                        </div>
                    </div>
