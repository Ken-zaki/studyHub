...
<main class="main-content">
    ...
    <div class="feed-column" id="feedColumn">
        ...
        <div class="create-post" id="createPostBox">
            ...
            <div class="cp-expanded" id="cpExpanded" style="display:none;">
                ...
                <div class="cp-footer">
                    ...
                    <div class="cp-attach-row">
                        ...
                        <button class="cp-attach-btn" title="Add a link"
                    ...
                    <div class="cp-actions-row">
                        <div class="cp-vis-wrap">
                            <button class="cp-vis-btn" id="cpVisBtn" onclick="toggleVisMenu()">
                                ...
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:12px;height:12px;"><polyline points="6 9 12 15 18 9"/></svg>
                            </button>
                            <div class="cp-vis-menu" id="cpVisMenu" style="display:none;">
                                <button class="cp-vis-option" onclick="setVisibility('public','🌐','Public')">
                                    <span>🌐</span><div><strong>Public</strong><small>Everyone on StudyHub</small></div>
                                </button>
                                <button class="cp-vis-option" onclick="setVisibility('friends','👥','Friends')">
                                    <span>👥</span><div><strong>Friends</strong><small>Your friends only</small></div>
                                </button>
                                <button class="cp-vis-option" onclick="setVisibility('only_me','🔒','Only Me')">
                                    <span>🔒</span><div><strong>Only Me</strong><small>Just you</small></div>
                                </button>
                            </div>
                        </div>
            ...
            <!-- Hidden file inputs -->
            <input type="file" id="cpMediaInput" multiple accept="image/*,video/*" style="display:none;" onchange="handleMediaFiles(this.files)">
            <input type="file" id="cpFileInput" multiple style="display:none;" onchange="handleAttachFiles(this.files)">
        </div>
...
<div class="modal-overlay" id="reportModal">
    <div class="modal" style="max-width:440px;">
        ...
        <div class="modal-actions" style="margin-top:16px;">
            ...
            <button class="btn-primary" style="background:var(--accent);border-color:var(--accent);" onclick="submitPostReport()">Submit Report</button>
        </div>
    </div>
</div>
    ...
    <div class="comments-drawer" id="commentsDrawer">
        ...
        <div class="comments-input-bar">
            ...
            <div class="comments-input-wrap">
                <textarea id="commentInput" class="comments-textarea"
...
<div class="modal-overlay" id="shareModal">
    <div class="modal" style="max-width:420px;">
        ...
        <p id="shareConfirmMsg" style="font-size:13px;color:#15803d;text-align:center;min-height:20px;margin-top:8px;"></p>
    </div>
</div>
