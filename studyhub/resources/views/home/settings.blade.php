        ...
        <main class="settings-content">
            ...
            <div id="panel-about" class="settings-panel active">
                ...
                <div class="about-desc-card">
                    <p>StudyHub is a web-based platform that helps students organize their academic life, manage study
                        schedules, track tasks and deadlines, and collaborate with peers. It brings together essential
                        tools like a calendar planner, task manager, study groups, and a shared resource library into
                        one centralized environment to improve productivity and learning efficiency.</p>
                </div>

                <div class="about-hero">
                    <div class="about-hero-tagline">Study smarter, stay organized, and succeed together.</div>
                    <div class="about-hero-mission">StudyHub aims to empower students by providing a centralized and
                        structured digital study environment where they can manage their academic responsibilities,
                        collaborate with others, and access shared learning resources—helping them stay organized,
                        reduce stress, and achieve better academic outcomes.</div>
                </div>
                    ...
                    @php
                        $faqs = [
                            [
                                ...
                                'a' =>
                                    'Yes! StudyHub is completely free for all students. Simply sign up with your email and you\'ll have full access to all features including study groups, resources, and the focus timer.',
                            ],
                            [
                                'q' => 'Can I join multiple study groups?',
                                'a' =>
                                    'Absolutely. You can join as many study groups as you like and even create your own. There\'s no limit to how many groups you can participate in.',
                            ],
                            [
                                'q' => 'How do I share resources with my peers?',
                                'a' =>
                                    'Navigate to the Resources section from the sidebar. You can upload files, share links, and organize materials by subject. Your friends and study group members can access anything you share publicly.',
                            ],
                            [
                                'q' => 'What is Focus Mode?',
                                'a' =>
                                    'Focus Mode is a distraction-free study timer based on the Pomodoro technique. It tracks your study sessions, lets you set goals, and helps you maintain a consistent study habit over time.',
                            ],
                            [
                                'q' => 'How do I add friends on StudyHub?',
                                'a' =>
                                    'Go to the Friends section in the sidebar. You can search for other students by name or username and send them a friend request. Once accepted, you\'ll appear in each other\'s friend lists.',
                            ],
                            [
                                'q' => 'Is my data kept private?',
                                'a' =>
                                    'We take your privacy seriously. Your personal data is stored securely and is never shared with third parties. You control who sees your profile and what you share on the platform.',
                            ],
                        ];
                    @endphp
            ...
            <div id="panel-theme" class="settings-panel">
                ...
                <div class="theme-accent-section">
                    <div class="accent-colors">
                        <div class="accent-color selected" style="background:#1a5f7a;" data-accent="#1a5f7a"
                            onclick="selectAccent(this)" title="Ocean (default)"></div>
                        <div class="accent-color" style="background:#7c3aed;" data-accent="#7c3aed"
                            onclick="selectAccent(this)" title="Purple"></div>
                        <div class="accent-color" style="background:#059669;" data-accent="#059669"
                            onclick="selectAccent(this)" title="Emerald"></div>
                        <div class="accent-color" style="background:#dc2626;" data-accent="#dc2626"
                            onclick="selectAccent(this)" title="Red"></div>
                        <div class="accent-color" style="background:#d97706;" data-accent="#d97706"
                            onclick="selectAccent(this)" title="Amber"></div>
                        <div class="accent-color" style="background:#db2777;" data-accent="#db2777"
                            onclick="selectAccent(this)" title="Pink"></div>
                        <div class="accent-color" style="background:#0891b2;" data-accent="#0891b2"
                            onclick="selectAccent(this)" title="Cyan"></div>
                    </div>
                    <div style="margin-top:10px; font-size:12px; color:var(--text-light);">Accent color is applied to
                        active nav items, buttons, and highlights.</div>
                </div>
                ...
                <div class="font-size-row">
                    <div>
                        ...
                        <div style="font-size:12px;color:var(--text-secondary);margin-top:2px;">Adjusts text size
                            across the platform</div>
                    </div>
            ...
            <div id="panel-notifications" class="settings-panel">
                ...
                @php
                    $notifToggles = [
                        ...
                        [
                            ...
                            'desc' => 'When someone reacts to your newsfeed post',
                            'default' => true,
                        ],
                        [
                            'id' => 'notif-post-comment',
                            'title' => 'Comments',
                            'desc' => 'When someone comments on your post',
                            'default' => true,
                        ],
                        [
                            'id' => 'notif-group-invite',
                            'title' => 'Study Group Invites',
                            'desc' => 'When you are invited to join a study group',
                            'default' => true,
                        ],
                        [
                            'id' => 'notif-resource',
                            'title' => 'New Resources',
                            'desc' => 'When a friend shares a new resource',
                            'default' => false,
                        ],
                        [
                            'id' => 'notif-messages',
                ...
                @foreach ($notifToggles as $toggle)
                    <div class="settings-toggle-row">
                        ...
                        <label class="toggle-switch">
                            <input type="checkbox" id="{{ $toggle['id'] }}" {{ $toggle['default'] ? 'checked' : '' }}
                                onchange="saveToggle('{{ $toggle['id'] }}', this.checked)">
                ...
                <div style="margin-top:20px;">
                    ...
                    <div class="settings-toggle-row">
                        ...
                        <label class="toggle-switch">
                            <input type="checkbox" id="notif-focus" checked
                                onchange="saveToggle('notif-focus', this.checked)">
                            <div class="toggle-track"></div>
                        </label>
                    </div>
                    <div class="settings-toggle-row">
            ...
            <div id="panel-account" class="settings-panel">
                ...
                <div class="settings-field-group">
                    <div class="settings-field">
                        ...
                        <div class="settings-field-value">
                            {{ trim(session('user_first_name', '') . ' ' . session('user_last_name', '')) ?: '—' }}
                        </div>
                ...
                <div class="settings-field-group" style="margin-bottom:20px;">
                    ...
                    <div class="settings-field">
                        ...
                        <form method="POST" action="{{ route('logout') }}" style="margin:0">
                            @csrf
                            <button type="submit" class="settings-field-action" style="color:#dc2626;">Sign
                                out</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="danger-zone">
                    ...
                    <div class="danger-desc">Deleting your account is permanent and cannot be undone. All your posts,
                        resources, and group memberships will be removed.</div>
                    <button class="danger-btn"
                        onclick="if(confirm('Are you sure? This cannot be undone.')) alert('Please contact support to delete your account.')">Delete
                        Account</button>
                </div>
            </div>
            ...
            <div id="panel-privacy" class="settings-panel">
                ...
                <div class="privacy-info-box">
                    🔒 StudyHub takes your privacy seriously. Your data is never sold or shared with third parties.
                    These settings let you control who can see your information.
                </div>
                ...
                @php
                    $privacyToggles = [
                        [
                            'id' => 'priv-profile-public',
                            'title' => 'Public Profile',
                            'desc' => 'Allow anyone on StudyHub to view your profile',
                            'default' => true,
                        ],
                        [
                            'id' => 'priv-show-online',
                            'title' => 'Show Online Status',
                            'desc' => 'Let your friends see when you are online',
                            'default' => true,
                        ],
                        [
                            'id' => 'priv-show-posts',
                            'title' => 'Public Posts',
                            'desc' => 'Allow non-friends to see your newsfeed posts',
                            'default' => false,
                        ],
                        [
                            'id' => 'priv-show-friends',
                            'title' => 'Show Friends List',
                            'desc' => 'Let others see who you are friends with',
                            'default' => true,
                        ],
                        [
                            'id' => 'priv-allow-requests',
                            'title' => 'Allow Friend Requests',
                            'desc' => 'Let other students send you friend requests',
                            'default' => true,
                        ],
                        [
                            'id' => 'priv-show-resources',
                            'title' => 'Public Resources',
                            'desc' => 'Allow others to discover resources you\'ve shared',
                            'default' => true,
                        ],
                    ];
                @endphp
