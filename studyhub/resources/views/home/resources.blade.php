            ...
            <div class="res-toolbar">
                <div class="res-search-wrap">
                    ...
                    <input type="text" id="searchInput"
                        placeholder="Search resources by title, subject, description…" oninput="filterResources()">
                ...
                <div class="res-filter-group">
                    <button class="res-filter-btn active" id="filterPublic" onclick="setVisibility('public', this)">🌐
                        Public</button>
                    <button class="res-filter-btn" id="filterPrivate" onclick="setVisibility('private', this)">🔒
                        Friends</button>
                </div>
            </div>
        ...
        <div class="modal" style="max-width:600px;">
            ...
            <div class="upload-section active" id="usec1">
                <div class="upload-dropzone" id="dropzone"
                    onclick="document.getElementById('fileInputMain').click()" ondragover="dragOver(event)"
                    ...
                    <input type="file" id="fileInputMain" multiple
                        accept="image/*,video/*,.pdf,.doc,.docx,.ppt,.pptx,.txt,.zip" style="display:none;"
                ...
                <label class="res-label">Text Content
                    <span style="color:var(--text-light);font-weight:400;">(optional — notes, summaries, study
                        material)</span>
                </label>
                <textarea id="uploadContent" class="res-input" rows="5" style="resize:vertical;"
            ...
            <div class="upload-section" id="usec2">
                <div style="display:flex;flex-direction:column;gap:14px;">
                    <div>
                        ...
                        <input type="text" id="uploadTitle" class="res-input"
                            placeholder="e.g. Chapter 4 – Calculus Notes">
                        <div class="field-error" id="errTitle"></div>
                    </div>
                    <div>
                        <label class="res-label">Description <span
                                style="color:var(--text-light);font-weight:400;">(optional)</span></label>
                        <textarea id="uploadDesc" class="res-input" rows="3" placeholder="Brief description of this resource…"
                            style="resize:vertical;"></textarea>
                    </div>
                    <div>
                        <label class="res-label">Text Content <span
                                style="color:var(--text-light);font-weight:400;">(optional — write notes directly, no
                                file needed)</span></label>
                        <textarea id="uploadContent" class="res-input" rows="5"
                            placeholder="Write your study notes, summaries, or any text content here…" style="resize:vertical;"></textarea>
                    </div>
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                        <div>
                            ...
                            <input type="text" id="uploadSubjectOther" class="res-input"
                                placeholder="Enter subject name…" style="display:none;margin-top:8px;">
                        ...
                        <div>
                            ...
                            <input type="text" id="uploadTypeOther" class="res-input"
                                placeholder="Describe the material type…" style="display:none;margin-top:8px;">
            ...
            <div class="res-detail-body">
                ...
                <div class="res-detail-main">
                    ...
                    <div class="res-detail-section" id="detailLinkSection" style="display:none;">
                        ...
                        <a class="res-detail-link-btn" id="detailLinkBtn" href="#" target="_blank"
                            rel="noopener">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="res-detail-section" id="reviewSection">
                        ...
                        <div class="res-rate-row" style="margin-bottom:14px;">
                            <div class="res-rate-stars" id="rateStars">
                                <span class="res-rate-star" data-v="1" onmouseenter="starHover(1)"
                                    onmouseleave="starOut()" onclick="starClick(1)">★</span>
                                <span class="res-rate-star" data-v="2" onmouseenter="starHover(2)"
                                    onmouseleave="starOut()" onclick="starClick(2)">★</span>
                                <span class="res-rate-star" data-v="3" onmouseenter="starHover(3)"
                                    onmouseleave="starOut()" onclick="starClick(3)">★</span>
                                <span class="res-rate-star" data-v="4" onmouseenter="starHover(4)"
                                    onmouseleave="starOut()" onclick="starClick(4)">★</span>
                                <span class="res-rate-star" data-v="5" onmouseenter="starHover(5)"
                                    onmouseleave="starOut()" onclick="starClick(5)">★</span>
                            </div>
                        ...
                        <div class="res-comment-form">
                            <div class="res-comment-avatar">
                                {{ strtoupper(substr(session('user_first_name', 'U'), 0, 1) . substr(session('user_last_name', 'U'), 0, 1)) }}
                            </div>
                            <div class="res-comment-input-wrap">
                                <textarea id="commentInput" class="res-comment-input" placeholder="Write a comment… (optional)" rows="2"
                                    oninput="autoResize(this)"></textarea>
                                <div style="display:flex;gap:8px;justify-content:flex-end;margin-top:6px;">
                                    <button class="res-comment-submit"
                                        style="background:#f3f4f6;color:var(--text-secondary);"
                                        onclick="submitRatingOnly()" title="Submit rating without a comment">
                                        ⭐ Rate Only
                                    </button>
                                    <button id="submitReviewBtn" class="res-comment-submit"
                ...
                <aside class="res-detail-sidebar">
                    <div class="res-detail-info-card">
                        <div class="res-info-row"><span class="res-info-label">Subject</span><span
                                class="res-info-val" id="infoSubject">—</span></div>
                        <div class="res-info-row"><span class="res-info-label">Type</span><span class="res-info-val"
                                id="infoType">—</span></div>
                        <div class="res-info-row"><span class="res-info-label">Visibility</span><span
                                class="res-info-val" id="infoVis">—</span></div>
                        <div class="res-info-row"><span class="res-info-label">Uploaded by</span><span
                                class="res-info-val" id="infoUploader">—</span></div>
                        <div class="res-info-row"><span class="res-info-label">Date</span><span class="res-info-val"
                                id="infoDate">—</span></div>
                        <div class="res-info-row" id="infoViewsRow" style="display:none;"><span
                                class="res-info-label">Views</span><span class="res-info-val" id="infoViews">—</span>
                        </div>
                    </div>
        ...
        <div class="modal" style="max-width:620px;">
            ...
            <div style="display:flex;flex-direction:column;gap:14px;">
                ...
                <div>
                    <label class="res-label">Description <span
                            style="color:var(--text-light);font-weight:400;">(optional)</span></label>
                    <textarea id="editDesc" class="res-input" rows="3" style="resize:vertical;"
                        placeholder="Brief description…"></textarea>
                </div>
                <div>
                    <label class="res-label">Text Content <span
                            style="color:var(--text-light);font-weight:400;">(optional — for text-only
                            resources)</span></label>
                    <textarea id="editContent" class="res-input" rows="6" style="resize:vertical;"
                        placeholder="Write your notes, summaries, or study material here…"></textarea>
                </div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                    <div>
                        ...
                        <input type="text" id="editSubjectOther" class="res-input"
                            placeholder="Enter subject name…" style="display:none;margin-top:8px;">
                    </div>
                    <div>
                        ...
                        <input type="text" id="editTypeOther" class="res-input" placeholder="Describe the type…"
    ...
    <div class="modal-overlay" id="reportModal">
        <div class="modal" style="max-width:460px;">
            ...
            <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:16px;">
                <label class="res-report-option"><input type="radio" name="reportReason"
                ...
                <label class="res-report-option"><input type="radio" name="reportReason"
                        value="Low quality content"> Low quality content</label>
                <label class="res-report-option"><input type="radio" name="reportReason" value="Other"> Other
