...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Crimson+Pro:wght@600;700&family=DM+Sans:wght@400;500;600;700&family=Space+Mono:wght@400;700&display=swap"
        rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/studyhub.css') }}">
    <link rel="stylesheet"
        href="{{ asset('css/focus-mode.css') }}?v={{ filemtime(public_path('css/focus-mode.css')) }}">
    <link rel="stylesheet"
        href="{{ asset('css/flashcards.css') }}?v={{ filemtime(public_path('css/flashcards.css')) }}">
    <link rel="stylesheet" href="{{ asset('css/quiz.css') }}?v={{ filemtime(public_path('css/quiz.css')) }}">
    <link rel="stylesheet"
        href="{{ asset('css/study-materials.css') }}?v={{ filemtime(public_path('css/study-materials.css')) }}">
</head>
...
<body>
    ...
    <div class="fm-wrapper" id="focusModeApp">
        ...
        <main class="fm-main" id="mainContent">
            ...
            <div class="screen screen-menu" id="screenMenu">
                ...
                @php
                    $trackerData = [
                        'session_count' => (int) session('focus_session_count', 0),
                        'total_seconds' => (int) session('focus_total_seconds', 0),
                    ];
                @endphp
                <script>
                    window.__trackerData = @json($trackerData);
                </script>

                <div class="session-tracker" id="sessionTracker" aria-label="Session statistics">
                    <div class="tracker-section-label">Your Session Tracker</div>
                    <div class="tracker-stats-grid">
                        @for ($i = 0; $i < 4; $i++)
                            <div class="tracker-stat-card" style="gap:8px;">
                                <div class="tracker-skeleton" style="width:40%;height:10px;margin-bottom:4px;"></div>
                                <div class="tracker-skeleton" style="width:60%;height:22px;"></div>
                                <div class="tracker-skeleton" style="width:50%;height:9px;margin-top:2px;"></div>
                            </div>
                        @endfor
                    </div>
                    <div class="tracker-two-col">
                        <div class="tracker-card" style="min-height:180px;">
                            <div class="tracker-skeleton" style="width:40%;height:12px;margin-bottom:18px;"></div>
                            @for ($i = 0; $i < 7; $i++)
                                <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;">
                                    <div class="tracker-skeleton" style="width:26px;height:10px;flex-shrink:0;"></div>
                                    <div class="tracker-skeleton" style="flex:1;height:7px;"></div>
                                    <div class="tracker-skeleton" style="width:30px;height:10px;flex-shrink:0;"></div>
                                </div>
                            @endfor
                        </div>
                        <div style="display:flex;flex-direction:column;gap:14px;">
                            <div class="tracker-card" style="min-height:100px;">
                                <div class="tracker-skeleton" style="width:40%;height:12px;margin-bottom:14px;"></div>
                                @for ($i = 0; $i < 3; $i++)
                                    <div style="display:flex;align-items:center;gap:10px;margin-bottom:9px;">
                                        <div class="tracker-skeleton"
                                            style="width:9px;height:9px;border-radius:50%;flex-shrink:0;"></div>
                                        <div class="tracker-skeleton" style="flex:1;height:10px;"></div>
                                        <div class="tracker-skeleton" style="width:34px;height:5px;flex-shrink:0;">
                                        </div>
                                    </div>
                                @endfor
                            </div>
                            <div class="tracker-card">
                                ...
                                <div style="display:flex;gap:7px;">
                                    @for ($i = 0; $i < 7; $i++)
                                        <div class="tracker-skeleton"
                                            style="width:30px;height:30px;border-radius:8px;flex-shrink:0;"></div>
                                    @endfor
                                </div>
                            </div>
                        </div>
            ...
            <div class="screen screen-content hidden" id="screenFlashcard">
                    ...
                    <button class="deck-add-btn" id="deckCreateBtn" type="button">
                        <span class="deck-add-circle" aria-hidden="true">
                            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke="#ffffff" stroke-width="2.5" stroke-linecap="round" fill="none"
                                    d="M12 5v14M5 12h14" />
                            </svg>
                        </span>
                        Add Decks
                ...
                <div class="deck-create-backdrop hidden" id="deckModalOverlay">
                    <div class="deck-create-form" id="deckCreateForm" role="dialog" aria-modal="true"
                ...
                <div class="hidden" id="deckContent">
                    <div class="deck-content-header">
                        <button class="back-btn deck-back-btn" id="deckBackBtn" type="button">← Back to
                            Decks</button>
                        <div>
                    ...
                    <div class="rm-library-header">
                        ...
                        <div style="display:flex; gap: 10px;">
                            <button class="rm-upload-btn" id="flashcardUploadPromptBtn" type="button">Upload
                                Materials</button>
                            <button class="rm-upload-btn" id="flashcardCreatePromptBtn" type="button">Create
                                Flashcards</button>
                        </div>
                    </div>
                    <section class="flashcard-stage" id="flashcardStage">
                        <button class="flashcard-nav flashcard-nav-left" id="flashcardPrevBtn" type="button"
                        ...
                        <button class="flashcard-nav flashcard-nav-right" id="flashcardNextBtn" type="button"
            ...
            <div class="flashcard-modal hidden" id="flashcardModal" aria-hidden="true">
                ...
                <div class="flashcard-modal-card" role="dialog" aria-modal="true"
                    aria-labelledby="flashcardModalTitle">
                    <div class="flashcard-modal-header">
                        <div>
                            <h3 class="flashcard-modal-title" id="flashcardModalTitle">Flashcard Studio</h3>
                            <p class="flashcard-modal-subtitle" id="flashcardModalSubtitle">Choose how you want to
                                continue.</p>
                        </div>
                        <button class="flashcard-modal-close" id="flashcardModalCloseBtn" type="button"
                            aria-label="Close flashcard studio">×</button>
                    </div>
                    ...
                    <div class="flashcard-modal-pane" id="flashcardUploadPane">
                        ...
                        <button class="materials-upload-btn" id="flashcardMaterialsUploadBtn" type="button">Upload
                            Material</button>
                    ...
                    <div class="flashcard-modal-pane hidden" id="flashcardCreatePane">
                        ...
                        <form class="flashcard-form" id="flashcardForm">
                            ...
                            <input class="flashcard-input" id="flashcardQuestion" type="text" maxlength="400"
                                placeholder="Type the question here" required>
                            <label class="flashcard-label" for="flashcardAnswer">Answer / Back</label>
                            <textarea class="flashcard-textarea" id="flashcardAnswer" maxlength="1000" placeholder="Type the answer here"
                                required></textarea>
                            <div class="flashcard-form-actions">
                                <button class="flashcard-cancel-btn" id="flashcardCancelBtn"
                                    type="button">Cancel</button>
                                <button class="flashcard-save-btn" id="flashcardSaveBtn" type="submit">Save
                                    Flashcard</button>
                            </div>
                        </form>
            ...
            <div class="screen screen-content hidden" id="screenQuiz">
                ...
                <section class="flashcard-stage hidden" id="quizStage">
                    <button class="flashcard-nav flashcard-nav-left" id="quizPrevBtn" type="button"
                        aria-label="Previous question">‹</button>
                    <div class="flashcard-stage-viewport">
                        <div class="flashcard-stage-track" id="quizStageTrack"></div>
                    </div>
                    <button class="flashcard-nav flashcard-nav-right" id="quizNextBtn" type="button"
                ...
                <div class="flashcard-modal hidden" id="quizModal" role="dialog" aria-modal="true"
                    aria-label="Quiz Question" aria-hidden="true">
                    <button class="flashcard-modal-close" id="quizModalCloseBtn" type="button"
                    ...
                    <div class="quiz-modal-pane" id="quizUploadPane">
                        ...
                        <button class="materials-upload-btn" id="quizMaterialsUploadBtn" type="button">Upload
                            Material</button>
                    ...
                    <div class="quiz-modal-pane hidden" id="quizCreatePane">
                        ...
                        <form class="quiz-form" id="quizForm">
                            ...
                            <textarea class="quiz-textarea quiz-question" id="quizQuestion" maxlength="500"
                                placeholder="Type the quiz question here" required></textarea>
                            <div class="quiz-options-grid">
                                <div>
                                    <label class="quiz-label" for="quizOptionA">Option A</label>
                                    <input class="quiz-input" id="quizOptionA" type="text" maxlength="400"
                                        placeholder="Answer choice A" required>
                                </div>
                                <div>
                                    <label class="quiz-label" for="quizOptionB">Option B</label>
                                    <input class="quiz-input" id="quizOptionB" type="text" maxlength="400"
                                        placeholder="Answer choice B" required>
                                </div>
                                <div>
                                    <label class="quiz-label" for="quizOptionC">Option C</label>
                                    <input class="quiz-input" id="quizOptionC" type="text" maxlength="400"
                                        placeholder="Answer choice C" required>
                                </div>
                                <div>
                                    <label class="quiz-label" for="quizOptionD">Option D</label>
                                    <input class="quiz-input" id="quizOptionD" type="text" maxlength="400"
                                        placeholder="Answer choice D" required>
                                </div>
                            </div>
                            <div class="quiz-form-row">
                                ...
                                <div>
                                    ...
                                    <textarea class="quiz-textarea quiz-explanation" id="quizExplanation" maxlength="1000"
        ...
        {{-- ══ MUSIC FAB ══ --}}
        <button class="music-toggle-fab hidden" id="musicToggleBtn" title="Toggle Focus Music"
        ...
        <div class="music-player-widget hidden" id="musicWidget">
            ...
            <div class="music-album-art">
                <img src="{{ asset('images/cat.gif') }}" alt="Cat Gif"
            ...
            <div class="music-controls">
                <button class="ctrl-btn ctrl-play" id="playPauseBtn" title="Play / Pause"
                    aria-label="Play or pause focus music">
        ...
        <button class="focus-fab" id="focusToggleBtn" title="Toggle Focus Mode" aria-pressed="false">
            <svg class="lock-icon lock-open" viewBox="0 0 24 24" id="lockOpen">
                <path
                    d="M12 1C9.24 1 7 3.24 7 6v1H5c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2h-2V6c0-2.76-2.24-5-5-5zm0 2c1.66 0 3 1.34 3 3v1H9V6c0-1.66 1.34-3 3-3zm0 9c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2z" />
            </svg>
    ...
    <script src="{{ asset('js/session-tracker.js') }}"></script>
