...
<body>
                    ...
                    @forelse($groups as $group)
                        <div class="sg-group-item" data-group-id="{{ $group->id }}"
                            ...
                            <div class="sg-group-info">
                                ...
                                <div class="sg-group-subject">{{ $group->subject ?? 'General' }} ·
                                    {{ $group->members_count }} members</div>
                            </div>
                        </div>
                    @empty
                        <div class="no-msg" style="margin-top:24px;">No groups yet.<br>Hit <strong>+</strong> to create
                            one!</div>
                    @endforelse
                </div>
            </aside>
                ...
                <div class="sg-chat-header" id="chatHeader" style="display:none;">
                    ...
                    <div class="sg-chat-header-actions">
                        <button class="btn-delete-group" onclick="deleteGroup()"
                            title="Delete this group">Delete</button>
                    </div>
                </div>
    ...
    <script>
        ...
        function renderMessages(messages, scroll) {
            ...
            messages.forEach(m => {
                console.log('sender_photo:', m.sender_photo);
