// ═══════════════════════════════════════════════════════════════════
// CONFIG  — injected by the blade view via window.CALENDAR_CONFIG
// ═══════════════════════════════════════════════════════════════════
const SB_URL = window.CALENDAR_CONFIG.supabaseUrl;
const SB_ANON = window.CALENDAR_CONFIG.supabaseAnonKey;
const SB_SVC = window.CALENDAR_CONFIG.supabaseSvcKey;
const TABLE = "calendar_events";
const UID = window.CALENDAR_CONFIG.userId;
